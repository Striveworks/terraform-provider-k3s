...
func NewK3sServerComponent(config map[string]any, registry map[string]any, version *string, binDir string) K3sServer {
	return &server{config: config, registry: registry, version: version, binDir: binDir}
}
